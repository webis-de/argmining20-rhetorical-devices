 ...
 * @generated */
public class Pclause_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Pclause.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("type.rhetoricDetection.Pclause");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("parent", "type.rhetoricDetection.Pclause");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Pclause_Type(JCas jcas, Type casType) {
    super(jcas, casType);

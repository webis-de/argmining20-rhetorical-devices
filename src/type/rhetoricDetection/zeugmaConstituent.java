 ...
 * @generated */
public class zeugmaConstituent extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(zeugmaConstituent.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected zeugmaConstituent() {/* intentionally empty block */}
   ...
   */
  public zeugmaConstituent(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public zeugmaConstituent(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public zeugmaConstituent(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();

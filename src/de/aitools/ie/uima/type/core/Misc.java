 ...
 * @generated */
public class Misc extends NamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Misc.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Misc() {/* intentionally empty block */}
   ...
   */
  public Misc(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Misc(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();

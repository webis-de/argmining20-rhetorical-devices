...
public class SourceDocumentInformation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.core.SourceDocumentInformation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "de.aitools.ie.uima.type.core.SourceDocumentInformation");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "de.aitools.ie.uima.type.core.SourceDocumentInformation");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "de.aitools.ie.uima.type.core.SourceDocumentInformation");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "de.aitools.ie.uima.type.core.SourceDocumentInformation");

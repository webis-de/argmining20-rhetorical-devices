...
public class Syllable extends Unit {
  ...
  public final static int typeIndexID = JCasRegistry.register(Syllable.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Syllable() {/* intentionally empty block */}
   ...
   */
  public Syllable(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Syllable(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
